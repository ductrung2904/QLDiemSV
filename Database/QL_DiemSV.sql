...
insert into SinhVien values(1800000047, N'Bùi Nguyễn Đức Trung', '29/04/2000', N'Nam', N'Củ Chi', '0903896224', 'LT', '')
insert into SinhVien values(1800000415, N'Mai Hữu Văn', '21/02/2000', N'Nam', N'222 Cô Bắc Q.1', '0949376324', 'LT', '')
insert into SinhVien values(1800000103, N'Đặng Quốc Lai', '22/12/2000', N'Nam', N'Q. Thủ Đức, TP. HCM', '0772960922', 'LT', '')
insert into SinhVien values(1800000190, N'Nguyễn Sơn Vũ', '25/04/2000', N'Nam', N'Gia Lai', '0949593374', 'LT', '')
insert into SinhVien values(1800000970, N'Dương Khang Hy', '10/07/2000', N'Nam', N'10/6/2A, KP1, TL29, P.Thạnh Lộc, Q34, TP.HCM', '0349939548', 'QTM', '')
insert into SinhVien values(1800001415, N'Đoàn Duy Khánh', '31/08/2000', N'Nam', N'Ấp Bến Chò, xã Thạnh Đức, huyện Gò Gầu, tp Tây Ninh', '0354202739', 'QTM', '')
insert into SinhVien values(1800000123, N'Phạm Minh Thể', '16/07/2000', N'Nam', N'43/46/71/41 vườn lài', '0355521899', 'QTM', '')
insert into SinhVien values(1800002415, N'Huỳnh Quốc Bảo', '14/05/2000', N'Nam', N'123 a mã lò quận bình tân', '0901648465', 'QTM', '')
insert into SinhVien values(1800000494, N'Nguyễn Thanh Phong', '05/10/2000', N'Nam', N'Chí Thạnh - Tuy An - Phú Yên', '0393637275', 'LT', '')
insert into SinhVien values(1800000225, N'Trần Thành Long', '21/02/2000', N'Nam', N'269/29/14 Phú Định p16 q8', '0928248494', 'LT', '')
insert into SinhVien values(1800000918, N'Hứa Ngọc Thiện', '25/10/2000', N'Nam', N'13c đường 20 ấp trung xã tân thông hội huyện củ chi', '0989023841', 'LT', '')
insert into SinhVien values(1800003415, N'Cao Thị Nhung', '14/06/2000', N'Nữ', N'Thôn 6, Hoằng Giang, Hoằng Hóa, Thanh Hóa', '0949376324', 'LT', '')
insert into SinhVien values(1800000825, N'Nguyễn Thị Thu Thủy', '15/06/2000', N'Nữ', N'240 Quang Trung f10 Gò Vấp tp HCM', '0765565904', 'LT', '')
insert into SinhVien values(1800000171, N'Nguyễn Hoàng Hiệp', '25/10/2000', N'Nam', N'73/2L Xuân Thới Đông 3, Hóc Môn', '0932107273', 'LT', '')
insert into SinhVien values(1800000942, N'Nguyễn Thị Kim Anh', '01/07/2000', N'Nữ', N'Tổ 9, Ấp Trung, xã Long Định,huyện Châu Thành, tỉnh Tiền Giang', '0347735730', 'QTM', '')
insert into SinhVien values(1800000517, N'Nguyễn Văn Thái', '10/09/2000', N'Nam', N'Bà Rịa Vũng Tàu', '0406411382', 'QTM', '')
insert into SinhVien values(1800000221, N'Lê Minh Quý', '22/06/2000', N'Nam', N'101/10 ấp tân thới 2 xã tân hiệp huyện Hóc môn', '0964111934', 'QTM', '')
insert into SinhVien values(1800000754, N'Phùng Thành Lộc', '28/06/2000', N'Nam', N'92 An Nhơn ,phường 71 ,Quận Gò vấp ,Hồ Chí Minh', '0406342557', 'LT', '')
insert into SinhVien values(1800000207, N'Lê Võ Quốc An', '31/08/2000', N'Nam', N'34A Nguyễn Thị Định, Phường An Phú, Quận 2', '0969223400', 'LT', '')
insert into SinhVien values(1800000936, N'Nguyễn Văn An', '09/11/2000', N'Nam', N'Tổ 23,ấp 2 Xã Đông Thạnh - Huyện Hóc Môn', '0327070875', 'LT', '')
insert into SinhVien values(1800000288, N'Lê Trung Kiệt', '20/06/2000', N'Nam', N'Phú Yên', '0355309280', 'LT', '')
insert into SinhVien values(1800000673, N'Dương Nguyễn Minh Quốc', '13/04/2000', N'Nam', N'Ấp 15, Tuyên Hòa, Biên Hòa, Đồng Nai', '0555572334', 'LT', '')
insert into SinhVien values(1800000271, N'Lê Thành Song', '09/04/2000', N'Nam', N'Ấp 1, Vĩnh Xương, Tân Châu, An Giang', '0328935998', 'QTM', '')
insert into SinhVien values(1800000206, N'Đỗ Quốc Việt', '13/07/2000', N'Nam', N'48 Hồ Biểu Chánh, P.11, Q.Phú Nhuận', '0932158413', 'QTM', '')

insert into Diem values(1800000047, 'KTLT', 29, 9, 10)
